    ...
    for form in forms:
        ...
        if created_time:
            ...
            try:
                ...
                created_time = date_obj.astimezone(
                      ZoneInfo("Asia/Kolkata")
                        ).strftime("%d %b %Y, %I:%M %p")
                print("Converted IST:", created_time)
...
def preview_form(form_id):
    ...
    form = get_form(form_id)
    print("Created:", form["created_at"])
    print("Updated:", form["updated_at"])
    print("Published:", form["published_at"])
